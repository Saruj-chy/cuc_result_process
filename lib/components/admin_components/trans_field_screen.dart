...
import 'package:cuc_result_processing/components/admin_components/trans_print_screen.dart';
...
class TransFieldScreen extends StatefulWidget {
  ...
  @override
  State<TransFieldScreen> createState() => _TransFieldScreenState();
}

class _TransFieldScreenState extends State<TransFieldScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppbar(title:"Transcript's Details",),
